...
poncho_json.messages = {
    ...
    save: {
        ...
        <p class="font--small"><strong>NOTE:</strong> Click &nbsp;<i class="fa-solid fa-download"></i> to download your meme to your device. Alternatively, right-click (desktop) or hold (mobile) image for additional download options. Click &nbsp;<i class="fa-solid fa-pen"></i> to continue editing.</p>`
    }
}
// On document ready
$(function () {
